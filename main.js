...
var productMacBook = contain.filter((values) =>
	values.innerText.includes("MACBOOK")
);
...
let isLogin = false;
let notChange = true;
const loginButton = $(".nav-search .cart ~ button");
...
// Truyen cac bien xem chi tiet san pham sang product.js
var viewInfoTitle = $(".viewinfo .title p").innerHTML;
